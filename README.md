...
<h1 style="font-size: 3em; color: #FF0000;">•  SOFTWARE DE ALMACENAMIENTO DE FACTURAS ELECTRONICAS CON BLOCKCHAIN</h1> 
...
Este es un software que almacena datos de facturacion electronica en tecnologia blockchain, usando python y mongodb.
